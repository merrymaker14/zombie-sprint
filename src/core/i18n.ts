...
const TEXT: Record<Language, Record<string, string>> = {
  en: {
    ...
    'brand.badge': '🧟 FRIENDLY ZOMBIE RACING · NO BLOOD',
    'brand.note': 'NO GORE · ONLY GOOFY ZOMBIE ENERGY',
  ...
  ru: {
    ...
    'brand.badge': '🧟 ДРУЖЕЛЮБНЫЕ ЗОМБИ-ГОНКИ · БЕЗ КРОВИ',
    'brand.note': 'БЕЗ СТРАШИЛОК · ТОЛЬКО СМЕШНАЯ ЭНЕРГИЯ ЗОМБИ',
