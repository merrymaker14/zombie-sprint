...
const TEXT: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sound.on': 'SOUND: ON',
    'sound.off': 'SOUND: OFF',
    'records.best': 'BEST {place} · {time}',
    'records.new': 'NEW TRACK RECORD!',
    'records.here': 'Best on this route: {place} · {time}',
    'records.loaded': 'Your records were loaded from your account.',
  ...
  ru: {
    ...
    'sound.on': 'ЗВУК: ВКЛ',
    'sound.off': 'ЗВУК: ВЫКЛ',
    'records.best': 'РЕКОРД {place} · {time}',
    'records.new': 'НОВЫЙ РЕКОРД ТРАССЫ!',
    'records.here': 'Лучшее на этой трассе: {place} · {time}',
    'records.loaded': 'Рекорды загружены из вашего аккаунта.',
